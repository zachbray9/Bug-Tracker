        ...
        <Card cursor="pointer" onClick={() => { ticketStore.setSelectedTicket(ticket); }}>
            ...
            <CardFooter>
                <Flex justifyContent="space-between" alignItems="center" width="100%">
                    ...
                    <Avatar name={ticket.assignee ? `${ticket.assignee.firstName} ${ticket.assignee.lastName}` : undefined} src={ticket.assignee?.profilePictureUrl || undefined} key={ticket.assignee ? `${ticket.assignee.firstName} ${ticket.assignee.lastName}` : "unassigned" } size="sm" />
                </Flex>
            </CardFooter>
        </Card>
    )
