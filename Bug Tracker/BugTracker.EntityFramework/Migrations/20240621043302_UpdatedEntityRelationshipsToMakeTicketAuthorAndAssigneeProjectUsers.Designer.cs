...
namespace BugTracker.EntityFramework.Migrations
{
    ...
    [Migration("20240621043302_UpdatedEntityRelationshipsToMakeTicketAuthorAndAssigneeProjectUsers")]
    partial class UpdatedEntityRelationshipsToMakeTicketAuthorAndAssigneeProjectUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugTracker.Domain.Models.Ticket", b =>
                {
                    ...
                    b.Property<Guid?>("AssigneeProjectId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BugTracker.Domain.Models.Comment", b =>
                {
                    ...
                    b.HasOne("BugTracker.Domain.Models.ProjectUser", "Author")
                        .WithMany("Comments")
                        .HasForeignKey("AuthorId", "ProjectId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BugTracker.Domain.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
